...
public class Clock : MonoBehaviour
{
    ...
    private float firstHour, secondHour, thirdHour, fourthHour, fifthHour, sixthHour, seventhHour, eighthHour, ninthHour, tenthHour;
    ...
    private void Update()
    {
        ...
        else if (gameManager.TimeElapsed >= ninthHour && gameManager.TimeElapsed < tenthHour)
        {
        ...
        else if(gameManager.TimeElapsed >= tenthHour)
        {
